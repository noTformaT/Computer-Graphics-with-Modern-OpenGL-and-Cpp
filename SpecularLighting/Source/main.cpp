...
// Shaders file
static const char* vShader = "../Shaders/vert_SpecularLighting.glsl";
static const char* fShader = "../Shaders/frag_SpecularLighting.glsl";
...
int main()
{
    ...
    capTexture = Texture((char*)"../Textures/brick.png");
    capTexture.LoadTexture();

    Light mainLight = Light(1.0f, 1.0f, 1.0f, 0.1f,
                            1.0f, -0.0f, -1.0f, 0.3f);
    ...
    while (!mainWindow.GetShouldClose())
    {
        ...
        uniformDirection = shaderList[0].GetDiffuseDirection();
